...
def main():
    ...
    try:
        ...
        cv2.imwrite('surfData/tmp/foto3.jpg', getFrameFromYoutube("https://www.youtube.com/watch?v=k44lojwL2Zk"), [cv2.IMWRITE_JPEG_QUALITY, 85])
    except:
    ...
    try:
            ...
            local = local.strftime('%d-%m-%Y %H:%M')
